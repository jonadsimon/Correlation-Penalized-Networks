...
cor1e3_file = 'ValidationLoss_Epoch100_Batch250000_Cor0.001000_Drop1.000000.csv'
# cor1e2_file = 'ValidationLoss_Epoch100_Batch250000_Cor0.010000_Drop1.000000.csv'
...
cor1e3_df = pd.read_csv(input_dir+'/'+cor1e3_file)
# cor1e2_df = pd.read_csv(input_dir+'/'+cor1e2_file)
...
plt.plot(cor1e3_df["Epoch"], cor1e3_df["Error"], linewidth=1.5, label="cor_reg=1e-3")
# plt.plot(cor1e2_df["Epoch"], cor1e2_df["Error"], linewidth=1.5, label="cor_reg=1e-2")
...
outfile_path = os.path.join(os.path.split(__file__)[0], 'Validation_Loss_Comparison_100epochs_2.png')
